...
class InterestAreaAdapter : RecyclerView.Adapter<InterestAreaAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return ViewHolder(view).apply {
            ...
            itemView.setOnClickListener {
                ...
                FragmentHome.nx = interestAreaArr[position].nx
                FragmentHome.ny = interestAreaArr[position].ny
                FragmentHome.areaName = interestAreaArr[position].areaName

                var areaName = interestAreaArr[position].areaName
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val item = interestAreaArr[position]
        holder.setItem(item)
    }

    // 아이템 갯수 리턴
    override fun getItemCount(): Int = interestAreaArr.size
    ...
    companion object {
        // InterestArea 배열
        var interestAreaArr = ArrayList<InterestArea>()
    }
}